...
window.addEventListener('DOMContentLoaded', function (event) {
  ...
  var scores, roundScore, activePlayer, middleDice, score0, score1, current0, current1; //Start the players'scores from zero
  ...
  document.querySelector(".btn-roll").addEventListener("click", function () {
    ...
    middleDice.src = "../img/dice-".concat(dice, ".png");
  });
});
